...
public class OAuth2AuthenticationProcessingFilter implements Filter {
	...
	private final static Log logger = LogFactory.getLog(org.springframework.security.oauth2.provider.authentication.OAuth2AuthenticationProcessingFilter.class);
	...
	public OAuth2AuthenticationProcessingFilter(UserRepository userRepository, AuthenticationManager authenticationManager) {
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException,
		...
		try {
			...
			if (authentication == null) {
				...
				UsernamePasswordAuthenticationToken authenticate = new UsernamePasswordAuthenticationToken(user.getProviderUserId(), user.getAccessToken(), user.getAuthorities());
